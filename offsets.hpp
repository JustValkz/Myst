 ...
 * Time Taken: 77669 ms (77.669000 seconds)
 * Total Offsets: 282
 */
...
namespace offsets {
    ...
    namespace Humanoid {
        ...
        inline constexpr uintptr_t Jump = 0x1D0;
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t ContentText = 0xDF8;
        inline constexpr uintptr_t Font = 0x1138;
        inline constexpr uintptr_t LineHeight = 0xF10;
        inline constexpr uintptr_t LocalizedText = 0xDF8;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0x1144;
        inline constexpr uintptr_t Modal = 0x9C5;
        inline constexpr uintptr_t RichText = 0x100E;
        ...
        inline constexpr uintptr_t TextSize = 0x114C;
        inline constexpr uintptr_t TextStrokeColor3 = 0x112C;
        inline constexpr uintptr_t TextStrokeTransparency = 0x1150;
        inline constexpr uintptr_t TextTransparency = 0x1154;
        inline constexpr uintptr_t TextTruncate = 0x1009;
        inline constexpr uintptr_t TextWrapped = 0x1008;
        inline constexpr uintptr_t TextXAlignment = 0x115C;
        inline constexpr uintptr_t TextYAlignment = 0xF58;
    }

    namespace TextLabel {
        inline constexpr uintptr_t ContentText = 0xB78;
        inline constexpr uintptr_t Font = 0xEB8;
        inline constexpr uintptr_t LineHeight = 0xC90;
        inline constexpr uintptr_t LocalizedText = 0xB78;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0xEC4;
        ...
        inline constexpr uintptr_t TextSize = 0xECC;
        inline constexpr uintptr_t TextStrokeColor3 = 0xEAC;
        inline constexpr uintptr_t TextStrokeTransparency = 0xED0;
        inline constexpr uintptr_t TextTransparency = 0xED4;
        inline constexpr uintptr_t TextTruncate = 0xED8;
        inline constexpr uintptr_t TextWrapped = 0xD88;
        inline constexpr uintptr_t TextXAlignment = 0xEDC;
    ...
    namespace VehicleSeat {
        ...
        inline constexpr uintptr_t Occupant = 0x1A8;
